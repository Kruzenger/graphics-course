  ...
  , useVsync{false}
{
  ...
  etna::create_program(
    kTextureName,
    {INFLIGHT_FRAMES_SHADERS_ROOT "toy.vert.spv", INFLIGHT_FRAMES_SHADERS_ROOT "texture.frag.spv"});
  etna::create_program(
    kShaderName,
  ...
  {
    flameBuffer.buf[i] = etna::get_context().createBuffer(etna::Buffer::CreateInfo{
      .size = sizeof(flameBuffer),
...
void App::drawFrame()
{
  ...
  if (nextSwapchainImage)
  {
    ...
    ETNA_CHECK_VK_RESULT(currentCmdBuf.begin(vk::CommandBufferBeginInfo{}));
    {
      ...
      params.mouse_x = mousePosition.x;
      params.mouse_y = mousePosition.y;
      params.time = kTime;
...

      {
        ...
        const auto set = etna::create_descriptor_set(
          ...
          {etna::Binding{
           ...
           etna::Binding{2, flameBuffer.buf[flameBuffer.counter].genBinding()}});
        ...
        // currentCmdBuf.pushConstants(graphicsPipeline.getVkPipelineLayout(),
